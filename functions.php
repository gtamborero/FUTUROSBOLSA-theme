...
//HACK PARA AUTO AÑADIR A UN NUEVO USUARIO REGISTRADO AL CURSO GRATIS
add_action( 'user_register', 'addfreecourse', 10, 1 );
function addfreecourse( $user_id ) {
ld_update_course_access($user_id, 622, $remove = false);
}
// HACK NO P en the content
