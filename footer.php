	...
	<footer id="footer">
				<div class="width100 bgblack ">
					<div class="row white minpad minpadtop " style="padding-bottom:3.2%;">
						...
						<div class="width70 h6static floatright textright medpadbottom medline">Copyright © 2015 <?php echo $_SERVER['SERVER_NAME']; ?> -  <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/aviso-legal" >Aviso Legal</a><br />Paseo de Gracia 12, 1° 08007 <span style="color:#aaa";>Barcelona</span><br />Telf: 639 36 41 40 &nbsp;|&nbsp; <a href="mailto:info@futurosbolsa.com" >info@futurosbolsa.com</a> Skype: <a href="skype:futurosbolsa?call">futurosbolsa</a></div>
