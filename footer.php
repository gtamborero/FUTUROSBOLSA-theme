	...
	<footer id="footer">
				<div class="width100 bgblack ">
					<div class="row white minpad minpadtop " style="padding-bottom:3.2%;">
						...
						<a href="//www.iproject.cat" target="_NEW" style="font-size:12px; float:left;">Handmade by &nbsp; <img src="//www.iproject.cat/iproject-blanco.png" style="margin-top:1.8%; float:right;"> </a>
