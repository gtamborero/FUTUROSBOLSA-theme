...
// Se crea Objeto
	$miObj = new RedsysAPI;
					...
					$kc = '6LVno8Mo4myDwbkbAY+TsKhIPbkiB3XC'; //Clave recuperada de CANALES
					$firma = $miObj->createMerchantSignatureNotif($kc,$datos);	

					if ($firma === $signatureRecibida){
						echo "FIRMA OK";
						//Aki tenemos que comprobar de que los $datos que me llegan en array, tienen una respuesta postiva del banco. lo //que antes era el Ds_Response 0000 que ahora se puede llamar tu puta madre
...
// Solo le pongo el curso al usuario si la respuesta del servidor es correcta
//if ($_POST['Ds_Response'] == "0000") {
//ld_update_course_access($userId, $courseId, $remove = false);
//}

//$superposts = $_POST["Ds_Order"];
//$tumadre = $_GET["tuputamadre"];

//echo "host: ".  $_SERVER['REMOTE_HOST'];
//echo "add: ".  $_SERVER['REMOTE_ADDR'];
$nombre_host = gethostbyaddr($_SERVER['REMOTE_ADDR']);
//echo $nombre_host;

$archivo = fopen("logREDSYS.txt", "a" );
fputs ($archivo, "\n\n Fecha: " . date("d-m-Y H:i:s") .  "\n HOST: " . $nombre_host . "\n IP: " . $_SERVER['REMOTE_ADDR'] . "\n RESPUESTA REDSYS: " . $decodec . "DS_RESPONSE = " . $dsResponse );
?>